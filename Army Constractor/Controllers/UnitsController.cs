...
namespace Army_Constractor.Controllers
{
    public class UnitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UnitID,UnitName,BaseUnitID,ArmorID,MeleeWeaponID,RangeWeaponID,SecondWeaponID,ShieldID,MountID,NumberOfCombatants,Description")] Unit unit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UnitID,UnitName,BaseUnitID,ArmorID,MeleeWeaponID,RangeWeaponID,SecondWeaponID,ShieldID,MountID,NumberOfCombatants,Description")] Unit unit)
        {
            if (ModelState.IsValid)
            {
